...
public class backtoorder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javax.swing.JButton printorder = new javax.swing.JButton();
        ...
        txtid.setFont(new java.awt.Font("Tahoma", Font.BOLD, 14)); // NOI18N

        vieworder.setBackground(new java.awt.Color(255, 102, 0));
        vieworder.setFont(new java.awt.Font("Tahoma", Font.BOLD, 14)); // NOI18N
        vieworder.setForeground(new java.awt.Color(255, 255, 255));
        vieworder.setText("عرض الاوردر");
        vieworder.addActionListener(evt -> vieworderActionPerformed());

        printorder.setBackground(new java.awt.Color(255, 102, 0));
        printorder.setFont(new java.awt.Font("Tahoma", Font.BOLD, 14)); // NOI18N
        printorder.setForeground(new java.awt.Color(255, 255, 255));
        printorder.setText("طباعه الاوردر");
        printorder.addActionListener(this::printorderActionPerformed);
    ...
    private void vieworderActionPerformed() {//GEN-FIRST:event_vieworderActionPerformed
        // TODO add your handling code here:
        view_Order();
